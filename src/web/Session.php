...
class Session extends \yii\redis\Session {
    ...
    public function setName($value) {
        //TODO:: 临时修复 在 cli 模式下使用 session 相关方法出现的 headers already sent 错误
        if (!$this->getIsActive()) {
            Yii::info("Session->setName Ignore,because it not active now,value=$value", __METHOD__);
            return false;
        }
        parent::setName($value); // TODO: Change the autogenerated stub
    }
